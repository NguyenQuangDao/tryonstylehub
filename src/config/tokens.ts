...
export const TOKEN_CONFIG = {
    ...
    PAYMENT_METHODS: [
        ...
        },
        {
            ...
            nameVi: 'PayPal',
            icon: '🅿️',
            svgIcon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M7.076 21.337H2.47a.641.641 0 0 1-.633-.74L4.944 3.72A.75.75 0 0 1 5.682 3h8.694c3.69 0 5.973 1.885 5.973 4.936 0 3.93-2.888 6.34-7.045 6.34h-4.24l-1.988 7.06z"/></svg>`,
            enabled: false,
            description: 'Pay with PayPal account',
            descriptionVi: 'Thanh toán qua tài khoản PayPal',
            currencies: ['USD'],
            color: '#0070BA',
            popularity: 2,
        },
        {
            ...
            nameVi: 'Ví MoMo',
            icon: '🟣',
            svgIcon: `<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10"/><path fill="white" d="M8 9h8v6H8z"/></svg>`,
            enabled: false,
            description: 'Popular e-wallet in Vietnam',
            descriptionVi: 'Ví điện tử phổ biến tại Việt Nam',
            currencies: ['VND'],
            color: '#A50064',
            popularity: 1,
        },
        {
            ...
            nameVi: 'VNPay',
            icon: '🔵',
            svgIcon: `<svg viewBox="0 0 24 24" fill="currentColor"><rect width="24" height="24" rx="4"/><path fill="white" d="M6 8h12l-6 8z"/></svg>`,
            enabled: true,
            description: 'National payment gateway',
            descriptionVi: 'Cổng thanh toán quốc gia',
            currencies: ['VND'],
            color: '#0E4F9A',
            popularity: 2,
        },
